...
#setwd("current_dir/")
tabulafacs = readRDS("tabulafacsV2.rds")
tabula_unnorm = readRDS("tabulaunnorm.rds") #no normalization
...
ercccontrols = read.delim2("cms_095046.txt") #ERCC concentration data from Thermo
