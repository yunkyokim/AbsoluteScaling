...
cols = read.csv(file = "tabulacols.csv") #consistent colors across figures
...
t_cell_df = data.frame(tissue = t_cell@meta.data$tissue,
...
b_cell_df = data.frame(tissue = b_cell@meta.data$tissue,
...
macrophage_df = data.frame(tissue = macrophage@meta.data$tissue,
...
endo_df = data.frame(tissue = endo@meta.data$tissue,
...
unique_cellpairs = unique_cellpairs[!duplicated(t(apply(unique_cellpairs, 1, sort))), ]
cols10X = read.csv("tabula10Xcols.csv")
